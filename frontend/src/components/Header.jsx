        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <Link
              ...
              className="flex items-center gap-2 bg-[#E91E63] text-white px-5 py-2.5 rounded-lg font-medium text-sm hover:bg-[#d81b60] transition-colors"
            >
              ...
              <div className="py-4 space-y-2">
                ...
                <div className="px-4 pt-4">
                  <Link
                    ...
                    className="flex items-center justify-center gap-2 bg-[#E91E63] text-white px-5 py-2.5 rounded-lg font-medium text-sm w-full"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    <Heart className="w-4 h-4" fill="currentColor" />
                    Donate Now
